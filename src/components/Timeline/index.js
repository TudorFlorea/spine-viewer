...
const Timeline = (props) => {
	const { animations, handleTimelinePlay } = props;
	...
	return (
		<Draggable>
			<div className="card timeline">
				{showTimeline ? (
					<>
						<Button text="Hide timeline" onClick={onShowTimelineToggle} />
						<div className="row">
							...
							<>
											...
											<li key={anim.id} className="collection-item">
												<div>
													...
													<a href="#!" className="secondary-content">
														<i
															onClick={handleAnimationDelete(anim.id)}
								...
								<Button
									...
									onClick={handleTimelinePlay(
										selectedAnimations.map((anim) => anim.name)
									)}
								/>
							</>
						)}
					...
					<Button text="Show timeline" onClick={onShowTimelineToggle} />
				)}
			</div>
		</Draggable>
	);
