...
export const spineDebug = (spineModule, PIXI)=>{
        ...
        class SpineDebug{
            ...
            drawRegionAttachments(){
                ...
                for(let i=0,len=slots.length; i<len; i++){
                    ...
                    if(!(attachment instanceof spineModule.core.RegionAttachment)){continue;};
            ...
            drawMeshHullAndMeshTriangles(){
                ...
                for(let i=0,len=slots.length; i<len; i++){
                    ...
                    if(!(attachment instanceof spineModule.core.MeshAttachment)){continue;};
            ...
            drawClipping(){
                ...
                for(let i=0,len=slots.length; i<len; i++){
                    ...
                    if(!slot.bone.active){continue;};
                    let attachment = slot.getAttachment();
                    if(!(attachment instanceof spineModule.core.ClippingAttachment)){continue;};
            ...
            drawBoundingBoxes(){
                ...
                let bounds = new spineModule.core.SkeletonBounds();
            ...
            drawPaths(){
                ...
                for(let i=0,len=slots.length; i<len; i++){
                    ...
                    if (!slot.bone.active){continue;};
                    let attachment = slot.getAttachment();
                    if(attachment instanceof spineModule.core.PathAttachment){
                        let nn = attachment.worldVerticesLength,
                            world = new Float32Array(nn);
                        attachment.computeWorldVertices(slot, 0, nn, world, 0, 2);
                        let x1 = world[2],
